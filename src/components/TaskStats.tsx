  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white border border-[#EAE3DC] rounded-[28px] p-5 sm:p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)]">
        ...
        <div className="pt-4 border-t border-[#EAE3DC] flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          {/* Status Tabs */}
          <div className="flex items-center gap-1.5 bg-[#F7F3F0] p-1.5 rounded-2xl border border-[#EAE3DC] overflow-x-auto">
            <button
              id="filter-all-btn"
